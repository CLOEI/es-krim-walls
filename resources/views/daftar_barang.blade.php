...
@section('body_content')
    ...
    <div class="text-left mt-12">
        <div class="flex space-x-2 items-center justify-center">
            <div class="flex items-center w-full border-2 border-gray-200 py-2 px-4 rounded-md bg-white">
            ...
            <a href="{{ route('cetak_laporan_stok') }}" class="block px-8 py-2 bg-[#8B52D3] text-white rounded-md cursor-pointer">Cetak</a>
        </div>
        <div class="mt-4">
            @if($products->isEmpty())
